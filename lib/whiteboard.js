window.whiteboard = (function(){
  ...
  function _shouldPaintStroke(e) {
    return _.activeBrush && !e.defaultPrevented &&
   ...
   *
   *  preconditions:: _.activeBrush != null
  ...
  function _setActiveBrush(e) {
    ...
    _.activeBrush = _brushFromEvent(e);
    return whiteboard;
  };
  ...
  /**
   * Event handler for brush paintStroke events
   *
   * @param {Event}
   * @return void
   * @api private
   */
  function _addBrushStrokeToCanvas(event) {
    //lazily instantiate the canvas for now
    //TODO: set up canvas defaults
    //
    _.activeCanvas = _.activeCanvas || new _.Canvas();
    _.activeCanvas.strokes.push(event.stroke);
  ...
  return _ = {
    ...
    */
    ...
    init: function() {
      ...
      this.on('Brush.*.paintStroke', _addBrushStrokeToCanvas);
      return this;
    }
  };
