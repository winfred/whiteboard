whiteboard.StrokeAction = (function(_){
  var module = "StrokeAction";
    ...
    function _createInternalEvent(name, action, DOMevent, target) {
      DOMevent = DOMevent || {};
      ...
      for(var action in actions) {
        ...
        strokeAction[action] = (function(action, fn){
          return  function(DOMevent){
            ...
            strokeAction.emit.apply(this, [action, _createInternalEvent(name, action, DOMevent, actions.target)]);
          };
